//-----------------------------------------------------------------------
// <copyright file="PredicateMapFuture.cs" company="github.com/jiefenn8">
...
namespace GraphLoom.Mapper.RDF.R2RML
{
    ...
    /// </summary>
    public class PredicateMapFuture : AbstractTermMap<PredicateMapFuture>, IRelationMap
    {
        /// <summary>
        ...
        private PredicateMapFuture(Builder builder) : base(builder) { }
        ...
        /// <summary>
        /// Builder class for <see cref="PredicateMapFuture"/>.
        /// </summary>
        public class Builder : AbstractTermMapBuilder<PredicateMapFuture>
        {
            /// <inheritdoc/>
            public Builder(IUriNode baseUri, INode baseValue, ValuedType valuedType) : base(baseUri, baseValue, valuedType) { }

            /// <inheritdoc/>
            public override PredicateMapFuture Build()
            {
                return new PredicateMapFuture(this);
            }
        }
    }
}
