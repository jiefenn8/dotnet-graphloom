...
{
    [TestFixture]
    public class RDFUriFactoryTest
    {
        ...
        public void WhenCreateUriFromTemplateSucceed_ShouldReturnExpectedURI()
        {
            ...
            Uri result = RDFUriFactory.FromTemplate("http://www.example.org/employee/{EMPNO}", row);
        ...
        public void WhenCreateUriFromStringSucceed_ShouldReturnExpectedURI()
        {
            ...
            Uri result = RDFUriFactory.FromString("http://www.example.org/");
            Assert.That(result, Is.EqualTo(expResult));
        }
